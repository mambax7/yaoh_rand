...
//  ------------------------------------------------------------------------ //
define("RAND_JS_FOLDER",XOOPS_URL. "/modules/yaoh_rand/js/");
define("RAND_CSS_FOLDER",XOOPS_URL. "/modules/yaoh_rand/css/");
class yr_jsloader{
	...
	public static function useMyjs(){
		$RAND_JS_FOLDER= RAND_JS_FOLDER;
		if(self::$useMyjs==false){
			self::$useMyjs = true;
			return "<script type='text/javascript' src='{$RAND_JS_FOLDER}myjs.js'></script>";
		}
	}
	//引用jquery
...
//引用JqueryTools
	public static function useJqueryTools(){
		...
		$return.="<script type='text/javascript' src='{$RAND_JS_FOLDER}jquery.tools.min.js'></script>";
		return $return;
		}
	}
//引用JqueryUI
...
//引用ColorPicker
	public static function useColorPicker(){
		$RAND_JS_FOLDER= RAND_JS_FOLDER;
		$RAND_CSS_FOLDER= RAND_CSS_FOLDER;
		$return='';
		if(self::$useColorPicker==false){
			self::$useColorPicker=true;
			//載入jquery
			$return.=self::useJquery();
			$return.="<script type='text/javascript' src='{$RAND_JS_FOLDER}spectrum.js'></script><link rel='stylesheet' href='{$RAND_CSS_FOLDER}spectrum.css' />";
		return $return;
		}
	}
//其他小工具
